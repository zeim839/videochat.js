...
describe('Permissions form', () => {
  ...
  it('Should be toggle-able', () => {
      const x = cy.get('span[class="MuiButtonBase-root MuiSwitch-switchBase MuiSwitch-colorPrimary PrivateSwitchBase-root MuiSwitch-switchBase MuiSwitch-colorPrimary Mui-checked css-5ryogn-MuiButtonBase-root-MuiSwitch-switchBase"]')
      .eq(0)
      const y = cy.get('span[class="MuiButtonBase-root MuiSwitch-switchBase MuiSwitch-colorPrimary PrivateSwitchBase-root MuiSwitch-switchBase MuiSwitch-colorPrimary Mui-checked css-5ryogn-MuiButtonBase-root-MuiSwitch-switchBase"]')
      .eq(1)

      cy.get('input[class="PrivateSwitchBase-input MuiSwitch-input css-1m9pwf3"]')
      .eq(0).click()
      cy.get('input[class="PrivateSwitchBase-input MuiSwitch-input css-1m9pwf3"]')
      .eq(1).click()
